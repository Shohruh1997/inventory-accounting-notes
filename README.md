# Складской учёт: как считать остатки, чтобы им верили

Заметки по доменной логике учёта товара: документы, движения, остатки,
себестоимость. Что ломается в наивной схеме и как это чинится.

По опыту проектирования складской CRM для розницы. Исходники приватные, доступ по
запросу.
...
## Рабочая схема: три уровня вместо одного числа
...
flowchart LR
    ...
    style M fill:#eef4ff,stroke:#6366f1,stroke-width:2px
